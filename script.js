// Content for each section of the webpage
const sections = {
...
// Function to load all sections' content into the main content area
function loadAllSections() {
  const contentDiv = document.getElementById("content");
  // Concatenate all section HTML strings and insert into the content div
  contentDiv.innerHTML = Object.values(sections).join("");
}

// Initially load all sections when the DOM is fully loaded
